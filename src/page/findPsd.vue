<template>
    <div class="main">
      ...
      <div class="registform">
       <group class="borderb">
            <x-input v-model="tel" mask='999 9999 9999' type='text' placeholder="请输入手机号" is-type="china-mobile" :max='13' required >
        <img slot="label" class="icon" src="../../static/img/login/user.png" >
           ...
           <group class="borderb">
              <x-input v-model="password" type='password'  placeholder="请输入新密码" required  :min="6">
        <img slot="label" class="icon"  src="../../static/img/login/password.png" >
      </x-input>
          </group>
          <x-button  type="primary" :disabled='isdisabled'  :show-loading='btnload'  class='btn'  @click.native="login">找回密码</x-button>
      </div>
      <div>
...
import {send,findpassword} from '../api/api';
